...
**SaaSからService-as-a-Softwareへの構造的転換。Next SaaS ビジネスモデル。**
...
シートベースの課金モデルは崩壊を始めた。Klarna は700人の顧客対応を25人分のAIに置き換え、Salesforceは「Agentforce」で自社SaaSの存在意義を自ら問い直している。$2兆の時価総額がSaaS市場から消失し、500席のライセンスが50席に圧縮される世界が、もう始まっている。

だが、本当の構造変化はその先にある。

ソフトウェアの市場規模は$1兆。サービスの市場規模は$6兆。AIが「ツール」を売る時代から「仕事の完了」を売る時代に移行したとき、TAMは6倍に拡大する。Sierra（$10B評価）、Harvey（$11B評価）、Mercor——すでにこの構造転換を体現するパイオニアたちが出現している。

**本書は、SaaSの死亡宣告ではない。AIが産業構造をどう書き換えるのか、その設計図だ。**

Sequoia Capital、BCG、Gartner、McKinseyの一次情報と、世界のパイオニア企業の実装事例を横断分析しながら、「次の1兆ドル企業」が満たすべき条件を構造化する。
...
| ファイル                                               | 言語           | 内容       |
| -------------------------------------------------- | ------------ | -------- |
| [saas-is-dead_JP.md](./docs/jp/saas-is-dead_JP.md) | 🇯🇵 日本語     | 本文（日本語版） |
| [saas-is-dead_EN.md](./docs/en/saas-is-dead_EN.md) | 🇺🇸 English | 本文（英語版）  |
...
| プロジェクト                              | 概要                                                     | リンク                                                                       |
| ----------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------- |
| **Depth & Velocity**                | 生成AI時代の新規事業開発方法論。本書第4章「Intelligence vs Judgement」と直接接続 | [GitHub](https://github.com/Leading-AI-IO/depth-and-velocity)             |
...
Issues and Pull Requests are welcome. SaaS/Service-as-a-Software領域の新事例・データの追加、各産業セクターへの適用分析、誤字脱字の修正など、皆様からのContributeを歓迎します。
